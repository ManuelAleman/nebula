...
import { Globe, Copy, Download, Trash2, Eye, Lock } from "lucide-react";
...
const FileListRow = ({file, onDownload, onDelete, onTogglePublic, onShareLink, getFileIcon} : FileListRowProps) => {
    return (
        <tr key={file.id}>
            ...
            <td className="px-6 py-4 whitespace-nowrap text sm text-gray-600">
                <div className="flex items-center gap-4">
                    <button
                        ...
                        className="flex items-center gsap-2 cursor-pointer group">
                        {file.isPublic ? (
                            <>
